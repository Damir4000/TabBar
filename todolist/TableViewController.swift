...
class TableViewController: UITableViewController {
    ...
    override func viewWillAppear(_: Bool){
            ...
            let deaults2 = UserDefaults.standard
        
            if let array2 = deaults2.object(forKey: "taskNumber"){
                arrayNumber = array2 as! [String]
        }
    ...
    func saveTasks (){
        ...
        deaults2.setValue(arrayNumber, forKey: "taskNumber")
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        cell.detailTextLabel?.text = arrayNumber[indexPath.row]
